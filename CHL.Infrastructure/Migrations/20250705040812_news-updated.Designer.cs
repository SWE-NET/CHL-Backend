...
namespace CHL.Infrastructure.Migrations
{
    ...
    [Migration("20250705040812_news-updated")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CHL.Domain.Models.News", b =>
                {
                    b.HasOne("CHL.Domain.Models.Club", null)
                        .WithMany("NewsList")
                    ...
                    b.HasOne("CHL.Domain.Models.Player", null)
                        .WithMany("NewsList")
                        .HasForeignKey("PlayerId");

                    b.HasOne("CHL.Domain.Models.Referee", null)
                        .WithMany("NewsList")
                        .HasForeignKey("RefereeId");

                    b.HasOne("CHL.Domain.Models.Stadium", null)
                        .WithMany("NewsList")
                        .HasForeignKey("StadiumId");
                });
